---
title: "Filter1 Immune Cells Only Marker Gene Detection"
...
AS.markers <- FindAllMarkers(AS.integrated, assay = "SCT", slot = "data", only.pos = TRUE, min.pct = 0.25, return.thresh = 0.01, pseudocount.use = 0.001, logfc.threshold = 0.25, test.use = "LR", latent.vars = "orig.ident", recorrect_umi = FALSE)

# save to file
write.table(AS.markers, file="DE-AS_filter1_immune.txt", sep="\t")
```
