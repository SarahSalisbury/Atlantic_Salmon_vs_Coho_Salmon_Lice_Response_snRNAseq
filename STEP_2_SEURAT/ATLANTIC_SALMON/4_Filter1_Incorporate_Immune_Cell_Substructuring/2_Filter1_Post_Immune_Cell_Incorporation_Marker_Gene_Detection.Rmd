---
title: "Filter1 Post Immune Cell Incorporation Marker Gene Detection"
...
Idents(object = AS.integrated) <- "SUBCLUSTER_MERGED" # the column where we broke down immune cells
...
AS.markers <- FindAllMarkers(AS.integrated, assay = "SCT", slot = "data", only.pos = TRUE, min.pct = 0.25, return.thresh = 0.01, pseudocount.use = 0.001, logfc.threshold = 0.25, test.use = "LR", latent.vars = "orig.ident")

# save to file
write.table(AS.markers, file="DE-AS_filter1_subsetted.txt", sep="\t")
```
