---
title: "Filter2 Post Immune Cell and Cluster12 Incorporation Marker Gene Detection"
...
CO.markers <- FindAllMarkers(CO.integrated, assay = "SCT", slot = "data", only.pos = TRUE, min.pct = 0.25, return.thresh = 0.01, pseudocount.use = 0.001, logfc.threshold = 0.25, test.use = "LR", latent.vars = "orig.ident")

# save to file
write.table(CO.markers, file="DE-CO_filter2_subsetted.txt", sep="\t")
```
