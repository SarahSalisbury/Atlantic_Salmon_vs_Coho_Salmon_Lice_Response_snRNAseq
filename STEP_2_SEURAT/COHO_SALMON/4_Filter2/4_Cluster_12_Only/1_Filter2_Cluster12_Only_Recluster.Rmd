...
CO.integrated <- RunPCA(CO.integrated, dims = 1:10) # Please note, "dims" is not a valid argument for RunPCA, therefore the default 50 PCs were generated here in contrast to what was reported in the "Sub-Clustering" section of the Methods in the manuscript.
```
