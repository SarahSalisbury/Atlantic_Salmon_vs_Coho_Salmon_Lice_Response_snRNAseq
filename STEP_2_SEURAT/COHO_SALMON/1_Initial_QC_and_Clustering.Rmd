...
#SKIN#
CO.sample25 <- Read10X(data.dir = "fin_01_sept_22/COout/lib25cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample24 <- Read10X(data.dir = "fin_01_sept_22/COout/lib24cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample33 <- Read10X(data.dir = "fin_01_sept_22/COout/lib33cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample37 <- Read10X(data.dir = "fin_01_sept_22/COout/lib37cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample34 <- Read10X(data.dir = "fin_01_sept_22/COout/lib34cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample41 <- Read10X(data.dir = "fin_01_sept_22/COout/lib41cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")

#FIN#
CO.sample44 <- Read10X(data.dir = "fin_01_sept_22/COout/lib44cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample45 <- Read10X(data.dir = "fin_01_sept_22/COout/lib45cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample16 <- Read10X(data.dir = "fin_01_sept_22/COout/lib16cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample09 <- Read10X(data.dir = "fin_11_may_22/out/lib9cohomulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample28 <- Read10X(data.dir = "fin_01_sept_22/COout/lib28cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
CO.sample10 <- Read10X(data.dir = "fin_11_may_22/out/lib10cohomulticore1passmultimapnmax10/Solo.out/GeneFull/raw/")
```
...
genes <- read.table("fin_01_sept_22/COout/lib25cohomtmulticore1passmultimapnmax10/Solo.out/GeneFull/raw/features.tsv", stringsAsFactors = F)
...
write.csv(genes, "FEATUREEnsembltosymbolCO.csv")
```
...
mtgenes <- c("ATP6","ATP8","COX1","COX2","COX3","CYTB","KEG53_r01","KEG53_r02","KEG53_t01","KEG53_t02","KEG53_t03","KEG53_t04","KEG53_t05","KEG53_t06","KEG53_t07","KEG53_t08","KEG53_t09","KEG53_t10","KEG53_t11","KEG53_t12","KEG53_t13","KEG53_t14","KEG53_t15","KEG53_t16","KEG53_t17","KEG53_t18","KEG53_t19","KEG53_t20","KEG53_t21","KEG53_t22","ND1","ND2","ND3","ND4","ND4L","ND5","ND6")
...
Alright so it's clearly there are some cells with super high mt DNA (percent,mt) we probably would be wise to get rid of these , the question is, where do you draw the line as to what is and is not ok in terms of mtDNA percentage?
...
cellcyclegenes <- read.csv("../CELL_CYCLE_GENES/CellCycleGenesCOVRAI.csv") # I generated this list manually, you will have to redo this for your study organism
...
# Ok we're going to try and remove everything now except CO.integrated to free up some memory
rm(list=setdiff(ls(), "CO.list_NoDoublets"))
```
...
features <- SelectIntegrationFeatures(object.list = CO.list_NoDoublets, nfeatures = 5000, normalization.method = "SCT")
```
...
CO.list_NoDoublets <- PrepSCTIntegration(object.list = CO.list_NoDoublets, anchor.features = features)
...
anchors <- FindIntegrationAnchors(object.list = CO.list_NoDoublets, anchor.features = features, normalization.method = "SCT", reduction = "rpca")
```
...
# At this point you may be running out of memory agai
# Ok we're going to try and remove everything now except CO.integrated to free up some memory
rm(list=setdiff(ls(), "CO.integrated"))
```
...
CO.integrated <- RunUMAP(CO.integrated, dims = 1:30, verbose = FALSE)
...
# First thing to do is to calculate the neighbourhood overlap (Jaccard index) between every cell and its k.param nearest neighbors (https://satijalab.org/seurat/reference/findneighbors)
# use the same number of dimensions as used for UMAP
CO.integrated <- FindNeighbors(CO.integrated, dims = 1:30)
...
saveRDS(CO.integrated, file = "CO.integrated.rds")
